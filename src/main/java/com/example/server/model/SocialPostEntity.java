...
public class SocialPostEntity {
    ...
    // Compatibility with other code: keep getSource/setSource but map to 'platform' field
    ...
    // Convenience constructor used by MockCollector and tests
    public SocialPostEntity(String content, java.time.LocalDateTime postDate, String source) {
        this.content = content;
        this.postDate = postDate;
        this.platform = source;
        // initialize lists to avoid NPE later
